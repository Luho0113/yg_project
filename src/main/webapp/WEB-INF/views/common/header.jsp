...
<body>
	<div>
						...
						<li>
							<div>
								...
								<form action="/search" method="get">
									<input class="main-input" id="search" name="search"
										value="${param.search}" placeholder="영화, 감독, 배우를 검색해보세요."
										onfocus="this.placeholder=''"
										onblur="this.placeholder='영화, 감독, 배우를 검색해보세요.'">
									<button class="search-button" onclick="return checkNull()">
				...
				<div class="navbar-right">
					<div class="navbar-userProfile">
						...
						<c:if test="${user.uiId != null}">
							<ul>
								<li><a href="/myInfo?uiNickname=${user.uiNickname}">내
										프로필</a></li>
		...
		<div class="header">
			<div class="logo">
				<a href="/"> <img
					src="../../../resources/images/yg_logo_main.png" />
				</a>
			</div>
		</div>
...
<script>
	function checkNull() {
		...
		if(inputValue.value.trim().length == null || inputValue.value.trim() == ""){
			...
			history.go(0);
			return false;
		} else if(inputValue.value.trim().length != null) {
			return true;
		}
