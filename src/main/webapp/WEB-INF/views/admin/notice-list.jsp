...
<div class="moveBtn">
<button class="admin-home" onclick="location.href='/admin/home'">영감 관리자 홈</button>
<button class="admin-logout" onclick="location.href='/admin/logout'">영감 관리자 로그아웃</button>
</div>
<button class="registerBtn" onclick="location.href='/admin/notice-register'">공지사항 등록</button>
<table class="noticeTable" border="2">
   ...
   <tr>
   	  <td>${notice.niNum}</td>	
      <td>
      <a href="/admin/notice?niNum=${notice.niNum}">${notice.niTitle}</a>
      </td>
      <td>${notice.adminNickName}</td>
      <td>${notice.niCredat}</td>
      <td>${notice.niCnt}</td>
      <td><button class="noticeUpdate" onclick="location.href='/admin/notice-update?niNum=${notice.niNum}'">수정</button>
