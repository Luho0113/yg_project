...
<body>
	...
	<section class="content">
		...
		<article class="highest-rated-movies">
			...
			<ul class="movies">
				...
				<c:forEach items="${MovieInfo}" var="MovieInfo" varStatus="status" begin="0" end="4">
					<li class="movie-box">
						<div>
							...
							<div class="cont-detail">
								...
								<div class="starPoint">
									<span class="star">★★★★★<span class="starRange">★★★★★</span>
										...
										<input type="hidden" class="riStar"
											   value="${BestMovieList[status.index].riStar}"
										       readonly="readonly">
									</span>
								</div>
							</div>
	...
	<script>
		...
		onload = function() {
			...
			for (i = 0; i < 5; i++) {
				const starPointArray = document
						.getElementsByClassName("starPoint");
