...
file="/WEB-INF/views/common/error-user.jsp"%> <%@ taglib prefix="fn"
      ...
      <div class="myInfo-all-wrap">
        ...
        <c:if test="${user.uiNickname == myReviews[0].uiNickname}">
          ...
          <div class="button-update">
            <button
              class="button-custom btnToOrange"
              ...
              <c:if test="${empty myReviews}">
                ...
                <c:if test="${user.uiId == myReview.uiId}">
                  ...
                  <div class="button-review">
                    <button
                      class="button-custom btnFromBlack"
              ...
              <c:forEach items="${myReviews}" var="myReview">
                <div class="user-review">
                  ...
                  <div class="user-review-info">
                    <span>댓글 ${myReview.rcCount}</span> <span>|</span>
                    <span
                      >작성일 ${fn:substring(myReview.riCredate, 0,10)}</span
                    >
                    <!-- 로그인한 유저와 리뷰의 유저의 아이디가 동일한 경우 -->
                    <c:if test="${user.uiId == myReview.uiId}">
                      <button
              ...
              <c:forEach items="${myComments}" var="myComment">
                <div class="user-comment">
                  ...
                  <div class="user-comment-info">
                    ...
                    <!-- 로그인한 유저와 리뷰의 유저의 아이디가 동일한 경우 -->
                    <c:if test="${user.uiId != myComment.uiId}">
                      <button onclick="deleteComment(${myComment.rcNum})">
                        삭제
                      </button>
                    </c:if>
                    <c:if test="${user.uiId != myComment.uiId}">
                      <button onclick="location.href='/report-file'">
                        신고
                      </button>
                    </c:if>
                  </div>
