...
<body>
	...
	<form method="POST" action="/myInfo-update" name="update_form" onsubmit="return isThereValue()" enctype="multipart/form-data">
		...
		<!-- 비밀번호 확인 입력 -->
		<div>
			<label> <input type="password" name="uiPasswordSame" id="uiPasswordSame" value="${user.uiPassword}" onkeyup="checkPwdSame()" placeholder="비밀번호 확인">
			</label>
		...
		<!-- 닉네임 입력 -->
		<div>
			<label> <input type="text" name="uiNickname" id="uiNickname" value="${user.uiNickname}" onkeyup="checkNickName()" placeholder="닉네임"> 
			</label>
