    ...
    <div class="content">
      ...
      <form method="POST" action="/login" name="login_form">
        ...
        <div class="input-wrap">
          <label> <input class="input" type="text" name="uiId" id="uiId" placeholder="아이디" /> <br /> </label>
        </div>

        <!-- 비밀번호 입력 -->
        <div class="input-wrap">
          <label>
            <input class="input" type="password" name="uiPassword" id="uiPassword" placeholder="비밀번호" />
            <br />
          </label>
        </div>
        ...
        <div class="error_message-wrap">
          <span class="error-message" style="display: none"> 아이디와 비밀번호를 입력해주세요. </span>
          <c:if test="${msg != null}">
