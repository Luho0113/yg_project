...
<body>
	...
	<!-- content area -->
	<div class="content">
		<form method="POST" action="/join" name="join_form"
			onsubmit="return isThereValue()" enctype="multipart/form-data">
			...
			<div>
				<label> <input type="text" name="uiId" id="uiId"
					onkeyup="checkId(this)" placeholder="아이디">
				</label> 
			...
			<div>
				<label> <input type="password" name="uiPassword"
					id="uiPassword" onkeyup="checkPwd()" placeholder="비밀번호">
				</label>
			...
			<div>
				<label> <input type="password" name="uiPasswordSame"
					id="uiPasswordSame" onkeyup="checkPwdSame()" placeholder="비밀번호 확인">
				</label>
			...
			<div>
				<label> <input type="text" name="uiNickname" id="uiNickname"
					onkeyup="checkNickName()" placeholder="닉네임">
				</label>
			...
			<div>
				<label> <input type="email" name="uiEmail" id="uiEmail"
					onkeyup="checkEmail()" placeholder="이메일">
