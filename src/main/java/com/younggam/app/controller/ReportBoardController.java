...
public class ReportBoardController {
   ...
   //관리자
   @GetMapping("/admin/report-update")
   public String reportUpdate(Model m, @RequestParam("piNum") int piNum) {
      ReportBoardVO report = piService.seeReport(piNum);
      m.addAttribute("report", report);
      return "admin/report/report-update";
   }

   //유저
   @PostMapping("/report-update")
   public String reportUpdate(ReportBoardVO report, Model m) throws Exception {
      String msg = "신고 글 수정이 실패하였습니다.";
   ...
   //관리자
      ...
      public String updateReport(ReportBoardVO report, Model m) throws Exception {
         String msg = "신고 글 수정이 실패하였습니다.";
         String url = "/admin/report-update?piNum=" + report.getPiNum();
         if (piService.updateReport(report)) {
            msg = "신고 글 수정이 완료되었습니다.";
            url = "/admin/reports";
         }
   ...
   public String reportDelete(Model m, @RequestParam("piNum") int piNum) {
      String msg = "신고 글 삭제가 실패하였습니다.";
      String url = "/report?piNum=" + piNum;
      if (piService.deleteReport(piNum)) {
         msg = "신고 글이 삭제되었습니다.";
         url = "/admin/reports";
      }
